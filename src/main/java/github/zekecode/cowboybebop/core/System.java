 ...
 * architecture.
 *
 * Systems are responsible for implementing game logic and behavior by operating on entities that
 ...
 *
 * Systems are registered with the {@link World} class and are automatically invoked during the
...
public interface System {
   ...
   *
   * The update method is called once per frame by the game loop and represents the core
   ...
   *
   * When implementing this method, care should be taken to ensure frame-rate independence by
