...
public class TransformComponentTest {
  ...
  void twoParameterConstructorInitializesCorrectly() {
    ...
    assertEquals(TEST_X, transform.getX(), DELTA, "X position should match constructor parameter");
    assertEquals(TEST_Y, transform.getY(), DELTA, "Y position should match constructor parameter");
    assertEquals(0.0, transform.getRotation(), DELTA, "Rotation should default to 0");
  }
  ...
  void rotationGetterAndSetter() {
    ...
    assertEquals(newRotation, transform.getRotation(), DELTA, "Rotation should update when set");
  }
  ...
  void handlesRotationValues() {
    ...
    assertEquals(
        posRotation, transform1.getRotation(), DELTA, "Should handle positive rotation values");
    ...
    assertEquals(
        negRotation, transform2.getRotation(), DELTA, "Should handle negative rotation values");
  }
